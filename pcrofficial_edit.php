...
<head>
    ...
    <!-- Title Page-->
    <title>Edit Patient Care Report</title>
...
<div class="col position-relative" id="personal_info">
  <div class="card">
      <div class="card-header"><h4 align="center" class="p-1">Personal Info</h4></div>
    <div class="card-body">
        <input type="hidden" value="<?php echo $row['id'];?>" class="form-control" name="update_id">
        <div class="form-row">
...
<div class="col position-relative" id="incident_info">
  <div class="card">
      <div class="card-header"><h4 align="center" class="p-1">Incident Info</h4></div>
    <div class="card-body">
        <div class="form-row">
...
<div class="col position-relative" id="vs_info">
  <div class="card">
      <div class="card-header"><h4 align="center" class="p-1">Vital Signs</h4></div>
         <div class="card-body">
              <div class="form-row">
                     <div class="form-group col-md-6">
                            <label>Time</label>
                                  ...
                                  <div class="row form-group">
                                    ...
                                    <div class="form-row">
                                        <div class="input-group">
                                              ...
                                              <input type="text" class="form-control col-md-3 ml-2" value="<?php echo $row['total'];?>" name="total" id="total_input" readonly="">
                                            </div>
                                 </div>
    </div>
  </div>
</div>
<div class="col position-relative" id="assesment">
  <div class="card">
      <div class="card-header"><h4 align="center" class="p-1">Assesment</h4></div>
    <div class="card-body">
 <div class="form-row">
                                    <div class="form-group col-md-4">
...
<div class="col position-relative" id="rescuer_info">
  <div class="card">
  ...
  <div class="row form-group">
                                ...
                                <div class="form">
                                    ...
                                    <div class="col">
                                        ...
                                        <input type="text" class="form-control" value="<?php echo $row['receiving_md'];?>" name="receiving_md" id="receiving_md">
                                    </div>
                                </div>
                                </div>
      ...
      $(document).ready(function(){
        ...
        $('#assesment').hide();
         $('#rescuer_info').hide();
          ...
          $('#list_patient').click(function(){
              $('#personal_info').toggle();
              $('#incident_info').hide();
              $('#vs_info').hide();
              $('#assesment').hide();
              $('#rescuer_info').hide();
              $('#list_patient').addClass('active in');
             ...
             $('#list_incident').click(function(){
                $('#incident_info').toggle ();
                 $('#personal_info').hide();
                $('#vs_info').hide();
                $('#assesment').hide();
                $('#rescuer_info').hide();
                $('#list_patient').removeClass('active');
                $('#list_incident').addClass('active in');
                 $('#list_vs').removeClass('active');
                 $('#list_assesment').removeClass('active');
                 $('#list_rescuer').removeClass('active');
          });
              $('#list_vs').click(function(){
                $('#vs_info').toggle ();
                 $('#personal_info').hide();
                $('#incident_info').hide();
                $('#assesment').hide();
                $('#rescuer_info').hide();
                $('#list_vs').addClass('active in');
                $('#list_patient').removeClass('active');
                $('#list_incident').removeClass('active');
                $('#list_assesment').removeClass('active');
                $('#list_rescuer').removeClass('active');
              ...
              $('#list_assesment').click(function(){
                $('#assesment').toggle ();
                 $('#personal_info').hide();
                $('#incident_info').hide();
                $('#vs_info').hide();
                $('#rescuer_info').hide();
                $('#list_assesment').addClass('active in');
                 $('#list_vs').removeClass('active in');
                $('#list_patient').removeClass('active');
                $('#list_incident').removeClass('active');
                $('#list_rescuer').removeClass('active');

          });
              $('#list_rescuer').click(function(){
                $('#rescuer_info').toggle ();
                 $('#personal_info').hide();
                $('#incident_info').hide();
                $('#vs_info').hide();
                $('#assesment').hide();
                 $('#list_rescuer').addClass('active in');
                   $('#list_assesment').removeClass('active in');
                 $('#list_vs').removeClass('active in');
                $('#list_patient').removeClass('active');
                $('#list_incident').removeClass('active');
          });
