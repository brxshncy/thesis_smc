...
<head>
    ...
    <!-- Title Page-->
    <title>Incident Statistics Report</title>
...
<div class="container-fluid">
    <div class="jumbotron" style="background-color: #fff;">
        ...
        $brgy = "SELECT incident_tally.incident_category as incident, COUNT(incident_tally.incident_category)  as tally FROM incident_tally GROUP BY incident_category";
...
$(document).ready(function(){
    var chart = {
            labels: <?php echo json_encode($incident) ?>,
            datasets:[
                {
                    label : "Incident Reports",
                    backgroundColor: 'rgba(245, 215, 110, 1)',
                    borderColor:'rgba(200, 200, 200, 0.75)',
                    hoverBackgroundColor : 'rgba(245, 229, 27, 1)',
